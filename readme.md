...
| PC Web调试               | Chrome（扩展[Advanced REST Client](https://github.com/jarrodek/ChromeRestClient)、FE助手等）、Firefox | [redux-logger](https://github.com/evgenyrodionov/redux-logger)、[Chrome Redux DevTools](https://github.com/zalmoxisus/redux-devtools-extension)、[React Developer Tools](https://github.com/facebook/react-devtools) |
...
1. [Chromium命令行启动参数](https://code.google.com/archive/p/xiaody/wikis/ChromiumCommandLineSwitches.wiki)
2. [什么是phantomJS？](http://div.io/topic/1413)
3. [mac 下安装运行 redis](http://yijiebuyi.com/blog/d8ab4b444c16f42cefe30df738a42518.html)
4. [文本三巨头：zsh、tmux 和 vim](http://blog.jobbole.com/86571/)
5. [让Git的输出更友好: 多种颜色和自定义log格式](https://www.pureweber.com/article/git-pretty-output/)
6. [Tmux使用方法](http://www.sbloger.com/blog/2013/07/09/about-tmux.html)
7. [终极 Shell——ZSH](http://zhuanlan.zhihu.com/mactalk/19556676)
8. [commandlinefu](http://www.commandlinefu.com/)
9. [curl 命令使用](http://www.cnblogs.com/wangkangluo1/archive/2012/04/17/2453975.html)
10. [Git 常用命令速查表](http://blog.csdn.net/sunboy_2050/article/details/7529841)
11. [为什么 Linux 的 htop 命令完胜 top 命令](https://linux.cn/article-3141-1.html)
12. [前端开源项目持续集成三剑客](http://mp.weixin.qq.com/s?__biz=MzIwNjQwMzUwMQ==&mid=2247484019&idx=1&sn=d674a16e56e4d503da8aabf8225a5387)
13. [一个靠谱的前端开源项目需要什么？](https://mp.weixin.qq.com/s?__biz=MzI2NzExNTczMw==&mid=2653284934&idx=1&sn=af82495f35adea9b919e27a20749145e)
14. [使用shipit-deploy实现自动化的多服务器部署](https://mp.weixin.qq.com/s/-MVmT6UKfnIeZXh5FaPs1w)
15. [和 Charles 同样强大的 iOS 免费抓包工具 mitmproxy](http://www.jianshu.com/p/6efd7f43e581)
